...
namespace XICommServer.Migrations
{
    ...
    [Migration("20231014153430_Added_MailEventLog")]
    partial class AddedMailEventLog
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("XICommServer.MailEventLogs.MailEventLog", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<bool>("IsLogSynced")
                        .HasColumnType("bit")
                        .HasColumnName("IsLogSynced");

                    b.Property<string>("MarketingCampainId")
                        .HasColumnType("nvarchar(max)")
                        .HasColumnName("MarketingCampainId");

                    b.Property<string>("MarketingCampainName")
                        .HasColumnType("nvarchar(max)")
                        .HasColumnName("MarketingCampainName");

                    b.Property<string>("SendGridEventId")
                        .HasColumnType("nvarchar(max)")
                        .HasColumnName("SendGridEventId");

                    b.Property<string>("SendGridMessageId")
                        .HasColumnType("nvarchar(max)")
                        .HasColumnName("SendGridMessageId");
                    ...
                    b.ToTable("AppMailEventLogs", (string)null);
                });

            modelBuilder.Entity("XICommServer.MailEvents.MailEvent", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("AppMailEvents", (string)null);
                });

            modelBuilder.Entity("XICommServer.SendGridKeys.SendGridKey", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("AppSendGridKeys", (string)null);
                });

            modelBuilder.Entity("XICommServer.WebHookConfigurations.WebHookConfiguration", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");

                    b.Property<string>("ApiSignatureVerificationKey")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)")
                        .HasColumnName("ApiSignatureVerificationKey");

                    b.Property<string>("ClientWebhookUrl")
                        .HasColumnType("nvarchar(max)")
                        .HasColumnName("ClientWebhookUrl");
                    ...
                    b.Property<bool>("ListenBounce")
                        .HasColumnType("bit")
                        .HasColumnName("ListenBounce");

                    b.Property<bool>("ListenClick")
                        .HasColumnType("bit")
                        .HasColumnName("ListenClick");

                    b.Property<bool>("ListenDeferred")
                        .HasColumnType("bit")
                        .HasColumnName("ListenDeferred");

                    b.Property<bool>("ListenDelivered")
                        .HasColumnType("bit")
                        .HasColumnName("ListenDelivered");

                    b.Property<bool>("ListenDropped")
                        .HasColumnType("bit")
                        .HasColumnName("ListenDropped");

                    b.Property<bool>("ListenGroupResubscribe")
                        .HasColumnType("bit")
                        .HasColumnName("ListenGroupResubscribe");

                    b.Property<bool>("ListenGroupUnsubscribe")
                        .HasColumnType("bit")
                        .HasColumnName("ListenGroupUnsubscribe");

                    b.Property<bool>("ListenOpen")
                        .HasColumnType("bit")
                        .HasColumnName("ListenOpen");

                    b.Property<bool>("ListenProcessed")
                        .HasColumnType("bit")
                        .HasColumnName("ListenProcessed");

                    b.Property<bool>("ListenSpamReport")
                        .HasColumnType("bit")
                        .HasColumnName("ListenSpamReport");

                    b.Property<bool>("ListenUnsubscribe")
                        .HasColumnType("bit")
                        .HasColumnName("ListenUnsubscribe");

                    b.HasKey("Id");

                    b.ToTable("AppWebHookConfigurations", (string)null);
                });
